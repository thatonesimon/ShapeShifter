...
public class Diffusion extends PAppletController implements Drawing {

    public Diffusion(PApplet pApplet) {
        super(pApplet);
    }
...
// http://hg.postspectacular.com/toxiclibs/src/44d9932dbc9f9c69a170643e2d459f449562b750/src.sim/toxi/sim/grayscott/GrayScott.java?at=default
    ...
    public void draw() {
        ...
        loadPixels();
        for (int i = 1; i < pApplet.width-1; i++) {
            for (int j = 1; j < pApplet.height-1; j ++) {
                Cell spot = grid[i][j];
                float a = spot.a;
                float b = spot.b;
                int pos = i + j * pApplet.width;
